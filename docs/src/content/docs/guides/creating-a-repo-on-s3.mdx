...
Let Sprout create and set a repo access key for you. This is your encryption key for your repo, **not your S3 access key**. They should be unique. *We have a plan to change the terminology here, as it does get confusing!*
